pipeline {
    ...
    environment {
        ...
        FRONTEND_REPO = '759912403559.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-frontend'
        BACKEND_REPO  = '759912403559.dkr.ecr.us-east-2.amazonaws.com/devops-challenge-backend'
    }
